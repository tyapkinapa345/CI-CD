dev@dev-vm:~/Downloads/lab__4/frontend$ microk8s kubectl get pods -w
NAME                               READY   STATUS    RESTARTS      AGE
backend-deploy-7fb7b5fc49-4kf4s    0/1     Running   2 (26s ago)   10m
frontend-deploy-5fcd46558-fg8vk    1/1     Running   0             10m
postgres-deploy-68f5d94f7f-bbfmb   1/1     Running   0             10m
backend-deploy-7fb7b5fc49-4kf4s    0/1     Error     2 (33s ago)   10m
backend-deploy-7fb7b5fc49-4kf4s    0/1     CrashLoopBackOff   2 (6s ago)    10m
backend-deploy-7fb7b5fc49-4kf4s    0/1     Running            3 (33s ago)   10m
backend-deploy-7fb7b5fc49-4kf4s    0/1     Error              3 (66s ago)   11m
backend-deploy-7fb7b5fc49-4kf4s    0/1     CrashLoopBackOff   3 (2s ago)    11m
backend-deploy-7fb7b5fc49-4kf4s    0/1     Running            4 (43s ago)   12m
^Cdev@dev-vm:~/Downloads/lab__4/frontend$ microk8s kubectl logs deployment/backend-deploy --tail=50

(Background on this error at: https://sqlalche.me/e/20/e3q8), retries left: 3
Database not ready: (psycopg2.OperationalError) could not translate host name "postgres-service" to address: No address associated with hostname

(Background on this error at: https://sqlalche.me/e/20/e3q8), retries left: 2
Database not ready: (psycopg2.OperationalError) could not translate host name "postgres-service" to address: No address associated with hostname

(Background on this error at: https://sqlalche.me/e/20/e3q8), retries left: 1
Database not ready: (psycopg2.OperationalError) could not translate host name "postgres-service" to address: No address associated with hostname

(Background on this error at: https://sqlalche.me/e/20/e3q8), retries left: 0

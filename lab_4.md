...
Было обновлено на русский язык, что ранее не было возможным (очень странно). Из-за вылета системы и перезапуска контейнера - код вошёл в действие.

![Форма создания](screenshots/upd_order_form_1.png)
